...
COMMENT ON COLUMN sample_group.updated_dy IS 'Who updated the record (if available)';
...
COMMENT ON COLUMN param.updated_dy IS 'Who updated the record (if available)';
...
COMMENT ON COLUMN param_property.updated_dy IS 'Who updated the record (if available)';

...
COMMENT ON COLUMN sample_group_history.updated_by IS 'Who updated the record (if available)';
...
COMMENT ON COLUMN param_history.updated_by IS 'Who updated the record (if available)';
...
COMMENT ON COLUMN param_property_history.updated_by IS 'Who updated the record (if available)';
